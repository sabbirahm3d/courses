...
UART_TRANSMIT_H:
    ...
    LDS TEMP0, UCSR0A
    SBRS TEMP0, UDRE
    RJMP UART_TRANSMIT_H

    ; send the data
    LDI TEMP, 0x48              ; hex for 'H'
    STS UDR0, TEMP
...
UART_TRANSMIT_E:
    ...
    LDS TEMP0, UCSR0A
    SBRS TEMP0, UDRE
    RJMP UART_TRANSMIT_E

    ; send the data
    LDI TEMP, 0x45              ; hex for 'E'
    STS UDR0, TEMP
...
UART_TRANSMIT_O:
    ...
    LDS TEMP0, UCSR0A
    SBRS TEMP0, UDRE
    RJMP UART_TRANSMIT_O

    ; send the data
    LDI TEMP, 0x4F              ; hex for 'O'
    STS UDR0, TEMP

UART_TRANSMIT_EXCLAMATION:

    ; Wait for empty transmit buffer
    LDS TEMP0, UCSR0A
    SBRS TEMP0, UDRE
    RJMP UART_TRANSMIT_EXCLAMATION

    ; send the data
    LDI TEMP, 0x21              ; hex for '!'
    STS UDR0, TEMP
