...
\lstset{frame=tb,
    ...
    tabsize=4,
    morekeywords=[1]{
        adc,add,adiw,sub,subi,sbc,sbiw,and,andi,or,ori,eor,com,
    ...
    sensitive=f,
    morecomment=[l];,
    keywordstyle=\color{darkblue}, % Instructions in blue, bold
    keywordstyle=[2]\color{burntorange}, % Registers and ports in orange
