...
theory_w2 = @(f) (1/2*(exp(-1j*pi*tau*(f-f_c))*tau.*sinc((f-f_c)*tau)+exp(-1j*pi*tau*(f+f_c))*tau.*sinc((f+f_c)*tau)));
theory_w3 = @(f) (1/2*(exp(1j*pi*tau*(f-f_c))*tau.*sinc((f-f_c)*tau)+exp(1j*pi*tau*(f+f_c))*tau.*sinc((f+f_c)*tau)));
