...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{cproof}
            ...
            Let $V$ denote the computer has a virus, and $D$ denote the detection programs detected it
            Therefore, given
            \begin{align*}
                P(D \mid V) &= 0.8\\
                P(D \mid V^C) &= 0.9\\
            ...
            \salign{1}
            \begin{align*}
                P(V^C \cap D) & = P(D \mid V^C)\cdot P(V^C)\\
                & = 0.9 \cdot 0.35& \\
                & = 0.315\\
                P(V \cap D) & = P(D \mid V)\cdot P(V)\\
                & = 0.8 \cdot 0.65\\
                & = 0.52\\
                P(D) &= P(V \cap D) + P(V^C \cap D)\\
                & = 0.835
            \end{align*}
            \endgroup

            Therefore, $P(D)=0.835$ and $P(D^C)=0.165$\\
            The probability that 9 or more of the 12 computers detect the virus
            \salign{1}
            \begin{align*}
                P(X \ge 9) & = \sum_{i=9}^{12}\binom{12}{i}P(D)^{i}P(D^C)^{12-i}\\
                & = 0.87835 \qedhere
            \end{align*}
            \endgroup
