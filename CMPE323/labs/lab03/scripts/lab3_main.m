...
pulse_conv(t, pulse(t, 1), pulse(t, 1), y_int, 'full');
...
pulse_conv(t, pulse(t, 2), pulse(t, 1), y_int, 'full');
...
pulse_conv(t2, pulse(t2 + 1, 2), pulse(t2, 1), y_int, 'same');
...
pulse_conv(t2, pulse(t2 + 1, 2), 2*d(t2-0.5), y_int, 'same');
