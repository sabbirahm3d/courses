...
\end{pseudocode}
    ...
    \section{Serial Algorithm} Table \ref{table:serialmat} visualizes the
    serial implementation of computing the LCS length of sample strings using
    the algorithm described in equation (15.9) of \textit{Introduction to
    Algorithms} \cite{Cormen:2009:IAT:1614191}.
...
\end{table}
    ...
    Milestone 1 required implementation of the serial LCS length algorithm and
    its analysis. Algorithm \thesection .\ref{alg2} provides the pseudocode for
    computing the length of the LCS. The serial algorithm utilizes the bottom-
    up approach to compute the LCS.
...
\end{pseudocode}
    ...
    the pseudocode for computing the length of the LCS. This version of the
    implementation uses the same LCS matrix to generate the same cell values.
    The parallel implementation however computes the values using a method that
    avoids race conditions. 

\begin{table}[h]
    \caption{LCS Matrix Constructed when Comparing \texttt{GCGTCA} and
    \texttt{ACGAA} with the Diagonal Subproblems Highlighted}
    \label{table:serialmat}
    \centering
    \setlength\tabcolsep{0pt}
    \begin{tabular}{|@{\rule[-0.5cm]{0pt}{1cm}}*{8}{M{1cm} |}}
    \hline
    ...
    \tikzmark{0}{$\bm{\varnothing}$} & \cellcolor{black!50}\tikzmark{a0}{0} &
    \cellcolor{black!20}\tikzmark{a1}{0} & \tikzmark{a2}{0} &
    \cellcolor{black!50}\tikzmark{a3}{0} & \cellcolor{black!20}\tikzmark{a4}{0}
    & \tikzmark{a5}{0} & \cellcolor{black!50}\tikzmark{a6}{0} \\

    \hline

    \tikzmark{0}{\textbf{A}} & \cellcolor{black!20}\tikzmark{b0}{0} &
    \tikzmark{b1}{0} & \cellcolor{black!50}\tikzmark{b2}{0} &
    \cellcolor{black!20}\tikzmark{b3}{0} & \tikzmark{b4}{0} &
    \cellcolor{black!50}\tikzmark{b5}{0} & \cellcolor{black!20}\tikzmark{b6}{1}
    \\

    \hline

    \tikzmark{0}{\textbf{C}} & \tikzmark{c0}{0} &
    \cellcolor{black!50}\tikzmark{c1}{0} & \cellcolor{black!20}\tikzmark{c2}{1}
    & \tikzmark{c3}{1} & \cellcolor{black!50}\tikzmark{c4}{1} &
    \cellcolor{black!20}\tikzmark{c5}{1} & \tikzmark{c6}{1} \\

    \hline

    \tikzmark{0}{\textbf{G}} & \cellcolor{black!50}\tikzmark{d0}{0} &
    \cellcolor{black!20}\tikzmark{d1}{1} & \tikzmark{d2}{1} &
    \cellcolor{black!50}\tikzmark{d3}{2} & \cellcolor{black!20}\tikzmark{d4}{2}
    & \tikzmark{d5}{2} & \cellcolor{black!50}\tikzmark{d6}{2} \\

    \hline

    \tikzmark{0}{\textbf{A}} & \cellcolor{black!20}\tikzmark{e0}{0} &
    \tikzmark{e1}{1} & \cellcolor{black!50}\tikzmark{e2}{1} &
    \cellcolor{black!20}\tikzmark{e3}{2} & \tikzmark{e4}{2} &
    \cellcolor{black!50}\tikzmark{e5}{2} &
    \cellcolor{black!20}\tikzmark{e6}{3} \\

    \hline

    \tikzmark{0}{\textbf{A}} & \tikzmark{f0}{0} &
    \cellcolor{black!50}\tikzmark{f1}{1} & \cellcolor{black!20}\tikzmark{f2}{1}
    & \tikzmark{f3}{2} & \cellcolor{black!50}\tikzmark{f4}{2} &
    \cellcolor{black!20}\tikzmark{f5}{2} & \tikzmark{f6}{3} \\
